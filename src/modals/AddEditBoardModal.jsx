    ...
    >
      ...
      <div className="scrollbar-hide overflow-y-scroll max-h-[95vh] bg-white dark:bg-[#2b2c37] text-black dark:text-white font-bold shadow-md shadow-[#364e7e1a] max-w-md mx-auto w-full px-8 py-8 rounded-xl ">
        ...
        <div className="mt-8 flex flex-col space-y-3">
          ...
          <input
            type="text"
            className="bg-transparent px-4 py-2 rounded-md text-sm border border-gray-600 outline-none focus:outline-[#4566e8]  ring-0"
          ...
          {newColumns.map((column, index) => {
            return (
              <div key={index} className="flex items-center w-full">
                <input
                  type="text"
                  className="bg-transparent flex-grow px-4 py-2 rounded-md text-sm border border-gray-600 outline-none focus:outline-[#4566e8]"
                  onChange={(e) => {
        ...
        <div>
          <button
            className="w-full items-center hover:opacity-75 dark:text-[#4566e8] dark:bg-white text-white bg-[#4566e8] mt-2 py-2 rounded-full"
            onClick={() => {
              setNewColumns((state) => [
                ...state,
          ...
          <button
            className="w-full items-center hover:opacity-75 dark:text-white dark:bg-[#4566e8] mt-8 relative text-white bg-[#4566e8] py-2 rounded-full "
            onClick={() => {
